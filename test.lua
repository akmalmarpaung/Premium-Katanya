...
local Window = Rayfield:CreateWindow({
    Name = "Script Fish it Gacor",
    LoadingTitle = "Stop Beli yang Quite punya ",
    LoadingSubtitle = "by @QuiteMemek",
    Theme = "Amethyst",
    ConfigurationSaving = {
        Enabled = true,
        FolderName = "Kontol",
...
DevTab:CreateParagraph({
    Title = "Quite Dev Abal Abal",
    Content = "Jangan Lupa Follow Ya Kont\nDeveloper:\n- Tiktok: tiktok.com/aldytoi\n- Instagram: @aldytoi\n- GitHub: github.com/aldyjrz\n\n"
})

DevTab:CreateButton({ Name = "Saweria", Callback = function() setclipboard("https://saweria.com") NotifySuccess("Link Saweria", "Copied to clipboard!") end })
